...
class Tacotron2Logger(SummaryWriter):
    ...
    def log_training(self, reduced_loss, reduced_mel_loss, reduced_gate_loss, grad_norm, learning_rate, duration,
                     iteration):
    ...
    def log_validation(self, reduced_loss, reduced_mel_loss, reduced_gate_loss, model, mel_outputs, gate_outputs, alignments, mel_targets, gate_targets, iteration):
